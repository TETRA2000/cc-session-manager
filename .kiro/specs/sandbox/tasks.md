...
- [x] 1. Sandbox type definitions and configuration
- [x] 1.1 Define sandbox types
...
- [x] 1.2 Extend application config loading
...
- [x] 2. Dependency detection service
- [x] 2.1 (P) Implement dependency checker
...
- [x] 3. Sandbox naming and hint cache
- [x] 3.1 (P) Implement sandbox name generation and persistence
...
- [x] 4. Docker Sandbox backend adapter
- [x] 4.1 Implement sbx CLI wrapper for lifecycle operations
...
- [x] 4.2 Implement sbx ls tabular output parser
...
- [x] 4.3 Implement sbx exec and streaming
...
- [x] 5. Native sandbox backend adapter
- [x] 5.1 (P) Implement native sandbox settings generation and launch
...
- [x] 6. Sandbox manager service
- [x] 6.1 Implement sandbox lifecycle orchestration
...
- [x] 7. Sandbox API routes
- [x] 7.1 Implement sandbox CRUD endpoints
...
- [x] 10. Whole-application sandboxing
- [x] 10.1 (P) Create Dockerfile and sandbox launch task
...
- [x] 11. Deno permission configuration
- [x] 11.1 Add sandbox-aware task variants to deno.json
...
- [ ] 12. Testing
- [x] 12.1 Unit tests for sandbox services
...
- [x] 12.2 Unit tests for sbx backend
