...
- [ ] 1. Define timeline data types and importance classifier
- [ ] 1.1 Add timeline-specific types to the shared type definitions
...
- [ ] 1.2 (P) Implement the importance classification function
...
- [ ] 1.3 (P) Implement lightweight timeline entry extraction from session files
...
- [ ] 2. Build the timeline API route with caching
- [ ] 2.1 Create the timeline route handler with cross-session aggregation
...
- [ ] 2.2 Add in-memory TTL cache with post-cache filtering
...
- [ ] 2.3 Register the timeline route in the API router
...
- [ ] 3. Build the timeline frontend view with routing and polling
- [ ] 3.1 Add timeline route to the frontend router and navigation
...
- [ ] 3.2 Build the root timeline view component with polling
...
- [ ] 3.3 (P) Build the importance filter bar component
...
- [ ] 3.4 (P) Build the active sessions sidebar component
...
- [ ] 3.5 (P) Build the pinned attention section component
...
- [ ] 3.6 Build the feed scroll container with auto-scroll behavior
...
- [ ] 3.7 (P) Build the individual feed entry component
...
- [ ] 4. Add timeline CSS styles
- [ ] 4.1 (P) Add timeline-specific CSS classes to the stylesheet
...
- [ ] 5. Add tests for timeline functionality
- [ ] 5.1 Add unit tests for the importance classifier
...
- [ ] 5.2 (P) Add unit tests for the lightweight timeline entry extractor
...
- [ ] 5.3 (P) Add integration tests for the timeline API route
...
- [ ] 5.4* Add frontend logic tests for pinned message computation and auto-scroll state
